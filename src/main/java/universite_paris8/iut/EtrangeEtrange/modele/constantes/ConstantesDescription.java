...
public class ConstantesDescription {
    ...
    public static final String DESCRIPTION_ARCHER = """
    ...
    public static final String DESCRIPTION_MAGE = """
    ...
    public static final String DESCRIPTION_NECROMANCIER = """
        ...
        Ma formation était impitoyable. Chaque jour, j'explorais les limites entre la vie et la mort, pratiquant des rituels macabres et apprenant les secrets des âmes perdues.
        ...
        Je suis l'ombre qui marche parmi les tombes, le murmure sinistre des âmes tourmentées.
