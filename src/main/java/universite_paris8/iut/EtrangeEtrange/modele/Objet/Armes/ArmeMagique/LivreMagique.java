...
public class LivreMagique extends Arme {
    ...
    public LivreMagique() {
        ...
        this.sortileges.add(ConstanteObjet.SORTILEGE1_LIVRE_MAGIQUE);
        this.sortileges.add(ConstanteObjet.SORTILEGE2_LIVRE_MAGIQUE);
        this.sortileges.add(ConstanteObjet.SORTILEGE3_LIVRE_SOIN);
    }
